  ...
  return (
    <div ref={container} className='md:w-[85vw] 2xl:w-[1300px] mx-auto flex lg:flex-row flex-col-reverse items-center justify-between pt-[25%] md:pt-8 lg:pt-0'>
        ...
        <div className='second__ relative drop-shadow-lg lg:w-[705px] w-[85vw] lg:h-[729px] h-[55vh] md:h-[60vh] bg-black/70 rounded-tr-3xl md:rounded-tr-[200px] rounded-tl-[20px]'>
            <Image priority src={proyectosData[0].imagen_principal_banner} alt={`${proyectosData[2].nombre} project image`} fill sizes="(max-width: 1200px) 85vw, 705px" className={`duration-1000 ${currentIndex === 0 ? 'opacity-100' : 'opacity-0'}  w-full h-full rounded-tl-[20px] rounded-tr-3xl md:rounded-tr-[200px] object-cover absolute left-0 top-0`} />
            <Image priority src={proyectosData[1].imagen_principal_banner} alt={`${proyectosData[1].nombre} project image`} fill sizes="(max-width: 1200px) 85vw, 705px" className={`duration-1000 ${currentIndex === 1 ? 'opacity-100' : 'opacity-0'} w-full h-full rounded-tl-[20px] rounded-tr-3xl md:rounded-tr-[200px] object-cover absolute left-0 top-0`} />
            <Image priority src={proyectosData[2].imagen_principal_banner} alt={`${proyectosData[0].nombre} project image`} fill sizes="(max-width: 1200px) 85vw, 705px" className={`duration-1000 ${currentIndex === 2 ? 'opacity-100' : 'opacity-0'} w-full h-full rounded-tl-[20px] rounded-tr-3xl md:rounded-tr-[200px] object-cover absolute left-0 top-0`} />
            <Link 
