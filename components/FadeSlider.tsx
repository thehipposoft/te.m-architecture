...
const FadeSlider = () => {
  ...
  return (
    <div className='md:w-[1200px] mx-auto flex items-center justify-between pt-8'>
        <div className='flex flex-col gap-6 justify-between md:h-[600px] pt-[10%]'>
            <div className='flex flex-col relative w-[340px]'>
                <div className={`duration-500 ${currentIndex === 0 ? 'opacity-100' : ''} flex flex-col absolute opacity-0  top-0`}>
                    <h4 className='uppercase text-[#DDDDDD] text-xl light'>{SLIDER_DATA[currentIndex].category}</h4>
                    <h2 className='text-[64px] text-[#DDDDDD] light leading-[65px]'>{SLIDER_DATA[currentIndex].name}</h2>
                </div>
                <div className={`duration-500 ${currentIndex === 1 ? 'opacity-100' : ''} flex flex-col absolute opacity-0  top-0`}>
                    <h4 className='uppercase text-[#DDDDDD] text-xl light opacity-0'>{SLIDER_DATA[currentIndex].category}</h4>
                    <h2 className='text-[64px] text-[#DDDDDD] light leading-[65px]'>{SLIDER_DATA[currentIndex].name}</h2>
                </div>
                <div className={`duration-500 ${currentIndex === 2 ? 'opacity-100' : ''} flex flex-col absolute opacity-0  top-0`}>
                    <h4 className='uppercase text-[#DDDDDD] text-xl light '>{SLIDER_DATA[currentIndex].category}</h4>
                    <h2 className='text-[64px] text-[#DDDDDD] light leading-[65px]'>{SLIDER_DATA[currentIndex].name}</h2>
                </div>
        ...
        <div className='relative drop-shadow-lg w-[795px] h-[829px]'>
