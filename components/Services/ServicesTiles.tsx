    ...
    <div ref={container} className='container md:px-16 md:ml-[5%] flex md:flex-row md:flex-wrap lg:flex-nowrap flex-col items-center py-8 lg:py-0 justify-center lg:justify-start xl:justify-center border border-solid border-[#DDDDDD] lg:h-[500px] lg:gap-5 gap-8 2xl:gap-12'>
        <div className=' flex flex-col md:gap-8  gap-2 justify-center'>
            <div className='group duration-300 rounded-tr-[50px] h-[184px] w-[290px] flex items-center relative shadow-md'>
                <Image 
                    src={'/assets/images/services/architecture-4.jpg'} 
                    alt='Service: Architecture image' 
                    fill
                    sizes='290px'
                    className=' object-contain rounded-tr-[50px]'
                 />
        ...
        <div className=' flex flex-col md:gap-8 gap-2 justify-center '>
            <div className='group hover:blur-lg duration-300 h-[184px] w-[290px] rounded-tr-[50px] flex items-center relative'>
                <Image 
                    src={'/assets/images/services/interior-2.jpg'} 
                    alt='Service: Interior Design image'
        ...
        <div className=' flex flex-col md:gap-8 gap-2 justify-center'>
            <div className='group hover:shadow-md duration-300 h-[184px] w-[290px] rounded-tr-[50px] flex items-center relative'>
                <Image 
                    src={'/assets/images/services/3d-visualization/ampliacion-tipal/1.jpg'} 
                    alt='Service: 3D Visualization image'
                    sizes='290px'
                    fill
                    className='rounded-tr-[50px]'
                 />
        ...
        <div className=' flex flex-col md:gap-8 gap-2 justify-center'>
            <div className='group hover:shadow-md h-[184px] w-[290px] duration-300 rounded-tr-[50px] flex items-center relative shadow-md'>
                <Image 
                src={'/assets/images/services/modeling-1.jpg'} 
                fill
                sizes='290px'
                alt='Service: Modeling image'
                className='rounded-tr-[50px] object-contain object-[40%]' />
                <div className='duration-500 group-hover:opacity-100 bg-white/70 blur-md backdrop-blur-lg absolute left-0 top-0 h-full w-full rounded-tr-[50px] opacity-0' />
