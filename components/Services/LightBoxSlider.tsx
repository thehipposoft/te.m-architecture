    ...
    return (
        <div className=''>
            <div className={'md:relative w-screen z-10'}>
                <div className="flex items-center md:max-w-[1300px] max-h-[95vh] overflow-hidden mx-auto">
                    {
                        projectImages.map((val:any, index:any) => (
                            <div
                                key={index}
                                className='duration-500 min-w-[1300px] flex justify-center items-center'
                                style={{
                            ...
                            >
                                <Image
                                    className='object-cover w-[1300px]'
                                    src={val.src} 
                                    alt={val.alt}
                                    key={index}
                                    width={1100}
                ...
                <button
                    className={`${imageIndex === 0 ? 'hidden' : ''} flex justify-center items-center border-none absolute md:top-[50%] md:bottom-0 bottom-[5%] md:left-[6%] left-[5%] cursor-pointer text-white duration-500 p-2 rounded-full w-9 h-9 bg-[#ffffff4a]`}
                ...
                <button
                    className="absolute border-none flex justify-center items-center md:top-[50%] md:bottom-0 bottom-[5%] md:right-[6%] right-[5%] cursor-pointer text-white duration-500 p-2 rounded-full w-9 h-9 bg-[#ffffff4a]"
                    onClick={showNextImage}
                >
