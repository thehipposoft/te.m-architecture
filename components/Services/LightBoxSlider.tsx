                ...
                <div className="flex items-center md:max-w-[1300px] max-h-[95vh] overflow-hidden mx-auto">
                    {
                        projectImages.map((val:any, index:any) => (
                            <div
                                key={index}
                                className='md:duration-500 duration-300 md:min-w-[1300px] w-screen md:w-auto flex justify-center items-center'
                                style={{
                            ...
                            >
                                <Image
                                    className='md:object-cover object-contain md:w-[1300px] w-screen'
                                    src={val.src} 
                                    alt={val.alt}
                                    key={index}
                                    width={1100}
