...
const Footer = () => {
  return (
    <div className='h-[415px] bg-[#c4c4c4] flex items-center'>
        <div className='flex justify-between w-[1100px] mx-auto gap-8'>
            <Image src={'/assets/images/logo-footer.png'} alt='' width={160} height={186} className='w-[160] h-[186px]' />
            <div className='flex flex-col gap-5'>
              <h5 className='text-white bold'>Information</h5>
            ...
            <div className='flex flex-col gap-5'>
              <h5 className='text-white bold'>Contacts</h5>
              <ul className=' flex flex-col gap-6 text-white'>
                ...
                <div className='flex gap-6'>
                    ...
                    <p className='text-white'>+39 342 326 5740</p>
                </div>
                <div className='flex gap-6'>
                  ...
                  <p className='text-white'>info@temarqui.com</p>
                </div>
              </ul>
            </div>
            <div className='flex flex-col gap-5'>
              <h5 className='text-white bold'>Social Media</h5>
