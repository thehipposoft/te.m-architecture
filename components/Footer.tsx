              ...
              <ul className=' flex flex-col gap-6 text-white p-0'>
                <div className='flex gap-6'>
                  ...
                  <div className='flex flex-col gap-4'>
                    <p className='text-white m-0 roboto'>Argentina</p>
                    <p className='text-white m-0 roboto'>Australia</p>
                    <p className='text-white m-0 roboto'>Spain</p>
                  </div>
                </div>
                <div className='flex items-center gap-6'>
                    ...
                    <p className='text-white roboto'>+39 342 326 5740</p>
                </div>
                <div className='flex items-center gap-6'>
                  ...
                  <p className='text-white roboto'>info@temarqui.com</p>
                </div>
              </ul>
            </div>
            <div className='flex flex-col gap-5'>
