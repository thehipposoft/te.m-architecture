    ...
    <div>
        <div className='flex flex-col items-center pt-[20%] md:pt-0'>
            <div className='border-t boreder-b my-8 flex items-center mx-auto'>
                <div id='about' className='md:w-[1250px] mx-auto md:h-[435px] py-8 flex flex-col md:flex-row justify-center md:gap-20 gap-8 bg-[#FBFBFB] rounded-tr-[200px]'>
                    <Image src={'/assets/images/about/about.jpg'} alt='Mica and Flor photo' width={1533} height={1750} className='md:w-[358px] w-[85vw] md:h-[457px] h-96 object-cover rounded-tl-2xl rounded-tr-[65px]' />
                    <div className='w-1/3 flex flex-col gap-4 justify-center'>
                        <p className='text-6xl text-[#DDDDDD] m-0'>About</p>
                        <p className='pt-4 m-0 leading-7 md:w-[485px] w-[85vw]'><strong className='bold'>We are Mica and Flor</strong>, lifelong friends united by a shared passion: design and architecture. We studied together at the National University of Córdoba, Argentina, and since then, we have shared the desire to create spaces that truly adapt to the people who inhabit them</p>
                    </div>
                </div>
            </div>
            <div className='md:w-[1250px] h-40 flex gap-16 justify-center items-center'>
            ...
            <div className='border-t boreder-b mt-8 mb-20 flex items-center mx-auto'>
                <div id='about' className='md:w-[1250px] w-[85vw] mx-auto md:h-[435px] py-8 flex flex-col md:flex-row-reverse justify-center md:gap-20 gap-8 bg-[#FBFBFB] rounded-tl-[200px]'>
                    <Image src={'/assets/images/about/about-2.jpg'} alt='Mica and Flor photo' width={1533} height={1750} className='md:w-[358px] w-[85vw] h-96 md:h-[457px] object-cover rounded-tl-2xl rounded-tr-[65px]' />
                    <div className='flex flex-col gap-4 justify-center'>
                        <p className='pt-1 m-0 leading-7 md:w-[475px]'>
                        ...
                        <p className='pt-1 m-0 leading-7 md:w-[485px]'>
