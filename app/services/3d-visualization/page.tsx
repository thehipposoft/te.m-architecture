...
import { AMPLIACION_TIPAL, ARMADALE_PROJECT, BLACKROCK_HOUSE, CASA_RAFITA, DM, DON_MARTIN } from './constants';
        ...
        <div className='flex flex-col gap-4'>
            ...
            <div className='flex items-center gap-8'>
                ...
                <div className='flex flex-col w-[685px]'>
                    <h1 className='bold text-xl uppercase'>3d Visualization</h1>
