    ...
    <div>
      <div className='flex flex-col md:w-[1170px] w-[85vw] mx-auto md:py-16 pt-[25%]'>
            <div className='flex flex-col gap-8 pb-12 pt-8 md:pt-0'>
                ...
                <div className='md:h-[350px] h-[500px] flex justify-center md:justify-start items-center md:items-start overflow-hidden relative w-[85vw] md:w-auto md:mx-0 mx-auto' id='projects'>
                    <div className='md:w-[1050px] md:pt-16 flex flex-col gap-4 relative z-[2]'>
